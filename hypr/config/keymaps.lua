...
hl.bind("ALT + V", hl.dsp.global("quickshell:controlcenter-audio"))
hl.bind("ALT + N", hl.dsp.global("quickshell:controlcenter-notifications"))
hl.bind(mainMod .. " + U", hl.dsp.global("quickshell:updates"))
